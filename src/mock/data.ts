...
export const mockStorefront: StorefrontData = {
  settings: { storeNameTh: 'Mellow Mart', storeNameEn: 'Mellow Mart', primaryColor: '#6d28d9', defaultTheme: 'system', allowUserTheme: true, pointsEnabled: true, reviewsEnabled: true, favoritesEnabled: true, reservationMinutes: 20, currency: 'THB', shippingFee: 50, shippingMode: 'CART', cartShippingFee: 50, shippingTermsTh:'ค่าจัดส่งที่แสดงเป็นราคาตั้งต้น พื้นที่พิเศษคิดเพิ่มตามจริง',shippingTermsEn:'Displayed shipping is the base rate; special areas are charged at actual cost.',shippingTermsVersion:1,remoteAreaTermsTh:'พื้นที่ห่างไกล พื้นที่ท่องเที่ยว และเกาะ คิดค่าส่งเพิ่มตามจริง',remoteAreaTermsEn:'Remote, tourist, and island destinations are charged at actual cost.',lowStockThreshold:3, pointsPerBaht: 10, minimumRedeemPoints: 100, maxRedeemPercent: 20, loaderKickerTh: 'ยินดีต้อนรับสู่', loaderKickerEn: 'Welcome to', loaderTitleTh: '', loaderTitleEn: '', loaderMessageTh: 'กำลังจัดชั้นสินค้าให้คุณ', loaderMessageEn: 'Curating the shelves for you', loaderLogoUrl: '' },
  categories: [
  ...
  products: [
    { id: 'p-1', type: 'READY', titleTh: 'คุกกี้หมีเนย', titleEn: 'Butter bear cookies', descriptionTh: 'คุกกี้เนยหอม บรรจุแยกชิ้น เก็บได้นาน 30 วัน', descriptionEn: 'Fragrant butter cookies, individually packed.', price: 189, shippingFee: 35, shippingCalculation: 'PER_UNIT', deposit: 0, stockOnHand: 8, reservedQuantity: 2, purchaseLimit: 3, points: 18, active: true, reviewEnabled: true, imageUrls: [], categoryId: 'dessert' },
    { id: 'p-2', type: 'PREORDER', titleTh: 'แก้วองุ่นม่วง', titleEn: 'Purple grape glass', descriptionTh: 'แก้วคอลเลกชันฤดูใบไม้ร่วง', descriptionEn: 'Autumn collection glass.', price: 359, shippingFee: 45, shippingCalculation: 'FLAT', deposit: 120, stockOnHand: 30, reservedQuantity: 4, purchaseLimit: 2, points: 35, active: true, reviewEnabled: true, imageUrls: [], categoryId: 'preorder', preorderCampaignId: 'campaign-1' },
    { id: 'p-3', type: 'READY', titleTh: 'เยลลี่พีช', titleEn: 'Peach jelly', descriptionTh: 'เยลลี่พีชเนื้อนุ่ม', descriptionEn: 'Soft peach jelly.', price: 99, shippingFee: 25, shippingCalculation: 'PER_UNIT', deposit: 0, stockOnHand: 12, reservedQuantity: 0, purchaseLimit: 5, points: 9, active: true, reviewEnabled: true, imageUrls: [], categoryId: 'dessert' },
    { id: 'p-4', type: 'PREORDER', titleTh: 'กล่องสุ่มฤดูใบไม้ร่วง', titleEn: 'Autumn blind box', descriptionTh: 'กล่องสุ่มลายพิเศษประจำฤดู', descriptionEn: 'Limited seasonal blind box.', price: 690, shippingFee: 55, shippingCalculation: 'PER_UNIT', deposit: 250, stockOnHand: 50, reservedQuantity: 19, purchaseLimit: 3, points: 69, active: true, reviewEnabled: true, imageUrls: [], categoryId: 'preorder', preorderCampaignId: 'campaign-1' },
  ],
