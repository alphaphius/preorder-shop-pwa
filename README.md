...
สำหรับ Schema v2 ระบบจะเพิ่มคอลัมน์ Account X ของลูกค้า, หลักฐานการยอมรับเงื่อนไขค่าส่ง และค่าส่งพื้นที่พิเศษ โดยไม่ลบข้อมูลเดิม หลังอัปเดต Apps Script ให้รัน **Preorder Shop** > **สร้าง/อัปเดตฐานข้อมูล** หนึ่งครั้ง
